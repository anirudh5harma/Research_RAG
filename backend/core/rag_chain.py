...
def get_conversational_rag_chain(retriever):
    ...
    qa_prompt = ChatPromptTemplate.from_messages([
        (
            ...
            "2. ALWAYS reproduce markdown tables from the context in your answer. "
            "   Copy the full table using markdown table syntax. Never say "
            "   'refer to the original document' for tables — the user cannot "
            "   see the original, only your response.\n"
            "3. When the context contains figure/image descriptions, present the "
            "   key findings directly. The images will be displayed alongside "
            "   your response automatically — do NOT tell the user to 'refer to "
            "   the original document' for figures.\n"
